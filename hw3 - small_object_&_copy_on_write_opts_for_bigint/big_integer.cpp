...
big_integer &big_integer::operator+=(const big_integer &rhs) {
    big_integer l = convert_c2(),              //0000...: +; 1111... : -
            r = rhs.convert_c2();
    l.value.make_editable();
    r.value.make_editable();
...
big_integer &big_integer::operator/=(const big_integer &rhs) {
    ...
    remainder.value.make_editable();
    divisor.value.make_editable();
...
int8_t big_integer::cmp(big_integer const& a, big_integer const& b) {
    ...
    x.value.make_editable();
    y.value.make_editable();
